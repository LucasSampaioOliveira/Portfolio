            ...
            <div className="flex flex-wrap justify-center gap-20 mt-28">
                ...
                <div className="w-96 h-96 shadow-3xl hover:bg-yellow-200 transition duration-1000">
                    <div className="relative">
                            ...
                            <img src="./i-movi.png" alt="" width={365} className="mt-3 ml-2.5 bg-cover"/>
                ...
                <div className="w-96 h-96 shadow-3xl hover:bg-yellow-200 transition duration-1000">
                    <div className="relative">
                            ...
                            <img src="./spotify.png" alt="" width={365} className="mt-3 ml-2.5 bg-cover"/>
                ...
                <div className="w-96 h-96 shadow-3xl hover:bg-yellow-200 transition duration-1000">
                    <div className="relative">
                            ...
                            <img src="./king-games.png" alt="" width={365} className="mt-3 ml-2.5 bg-cover"/>
                ...
                <div className="w-96 h-96 shadow-3xl hover:bg-yellow-200 transition duration-1000">
                    <div className="relative">
                            ...
                            <img src="./pincel.png" alt="" width={365} className="mt-3 ml-2.5 bg-cover"/>
                ...
                <div className="w-96 h-96 shadow-3xl hover:bg-yellow-200 transition duration-1000">
                    <div className="relative">
                            ...
                            <img src="./business-patrimony.png" alt="" width={365} className="mt-3 ml-2.5 bg-cover"/>
